...
import io.swagger.client.model.ResponseBankingProductById;
import io.swagger.client.model.ResponseBankingProductList;
...
public class BankingApIsApi {
    private ApiClient apiClient;

    public BankingApIsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BankingApIsApi(ApiClient apiClient) {
     ...
     */
    public com.squareup.okhttp.Call getProductDetailAsync(String productId, final ApiCallback<ResponseBankingProductById> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listProductsCall(String effective, OffsetDateTime updatedSince, String brand, String productCategory, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listProductsValidateBeforeCall(String effective, OffsetDateTime updatedSince, String brand, String productCategory, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ResponseBankingProductList listProducts(String effective, OffsetDateTime updatedSince, String brand, String productCategory, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<ResponseBankingProductList> resp = listProductsWithHttpInfo(effective, updatedSince, brand, productCategory, page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listProductsAsync(String effective, OffsetDateTime updatedSince, String brand, String productCategory, Integer page, Integer pageSize, final ApiCallback<ResponseBankingProductList> callback) throws ApiException {
