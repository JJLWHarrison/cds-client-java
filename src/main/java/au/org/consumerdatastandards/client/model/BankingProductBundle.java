...
public class BankingProductBundle  {
    ...
    @ApiModelProperty(value = "Display text providing more information on the bundle", required = false)
    ...
    @ApiModelProperty(value = "Link to a web page with more information on the bundle criteria and benefits", required = false)
    ...
    public BankingProductBundle additionalInfoUri(URI additionalInfoUri) {
        this.additionalInfoUri = additionalInfoUri;
        return this;
    }
    
        
    @ApiModelProperty(value = "Array of product IDs for products included in the bundle", required = true)
    ...
    public boolean equals(java.lang.Object o) {
        ...
        if(! (productIds.equals(inputModel.getProductIds()))) { return false; }
        return true;
    }
